...
export function Hero() {
  return (
    <section className="relative">
      <ParallaxScene>
        <Reveal className="flex flex-col items-center gap-6 px-6 pb-40 text-center">
          ...
          <div className="mt-4 flex flex-col gap-4 sm:flex-row">
            <Button href="#about" size="lg" skull>
              Enter the graveyard
            </Button>
        ...
        <a
          href="#about"
          aria-label="Scroll down into the graveyard"
          className="absolute bottom-6 left-1/2 -translate-x-1/2 text-2xl text-foreground/50 transition-colors hover:text-accent-bright"
        >
